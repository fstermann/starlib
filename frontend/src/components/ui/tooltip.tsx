  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        {showArrow && (
          <TooltipPrimitive.Arrow className="border-border bg-popover fill-popover z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] border" />
        )}
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
