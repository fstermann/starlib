  ...
  return (
    <SheetPortal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=closed]:animate-out data-[state=open]:animate-in fixed z-50 flex flex-col gap-4 shadow-lg transition duration-300 ease-in-out outline-none",
          SIDE_CLASSES[side],
          className,
        )}
        {...props}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex flex-col-reverse gap-2 border-t px-4 py-3 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    />
